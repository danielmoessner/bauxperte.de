    ...
    <section className="relative z-20">
      <Container layout="full">
        <div className="relative overflow-hidden">
          ...
          {/* triangle stuff top */}
          <div className="absolute top-0 left-0 z-0 w-full h-1 origin-top-left transform translate-x-[60%] rotate-[5deg] bg-x-green"></div>
          <div className="absolute top-0 left-0 z-0 w-full h-1 origin-top-right transform -translate-x-[40%] -rotate-[7deg] bg-x-green"></div>
          ...
          {/* triangle stuff bot */}
          <div className="absolute bottom-0 left-0 z-0 w-full h-1 origin-bottom-left transform translate-x-[40%] -rotate-[5deg] bg-x-green"></div>
          <div className="absolute bottom-0 left-0 z-0 w-full h-1 origin-bottom-right transform -translate-x-[60%] rotate-[7deg] bg-x-green"></div>
